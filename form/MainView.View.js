																...
																new sap.ui.layout.form.FormElement(
																		{
																			fields : [ new sap.ui.commons.Image(
																					{
																						src : "../../commons/demokit/images/male.jpg",
																						width : "100px",
											...
											new sap.ui.layout.form.FormContainer(
													"F1C2",
													{
														title : new sap.ui.core.Title(
																{
																	text : "Address",
																	icon : "../../commons/demokit/images/address.gif",
																						...
																						select : function(
																							...
																							var oForm = sap.ui
																									...
																									.byId(
																											"F1");
																							if (oEvent
																									.getParameter("selectedIndex") == 0) {
																								oForm
																										.setLayout(oLayout1);
																							} else if (oEvent
																									.getParameter("selectedIndex") == 1) {
																								oForm
																										.setLayout(oLayout2);
																							} else {
																								oForm
